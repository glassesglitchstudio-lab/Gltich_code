...
beforeAll(async () => {
  ...
  mock.module("@glitchcode/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@glitchcode/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@glitchcode/ui/icon", () => ({ Icon: () => null }))
  mock.module("@glitchcode/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
