import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@glitchcode/sdk/v2"
import { SessionTurn } from "@glitchcode/ui/session-turn"
import { SessionReview } from "@glitchcode/ui/session-review"
import { DataProvider } from "@glitchcode/ui/context"
import { FileComponentProvider } from "@glitchcode/ui/context/file"
import { WorkerPoolProvider } from "@glitchcode/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@glitchcode/ui/logo"
import { IconButton } from "@glitchcode/ui/icon-button"
import { ProviderIcon } from "@glitchcode/ui/provider-icon"
import { iife } from "@glitchcode/shared/util/iife"
import { Binary } from "@glitchcode/shared/util/binary"
import { NamedError } from "@glitchcode/shared/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import z from "zod"
import NotFound from "../[...404]"
import { Tabs } from "@glitchcode/ui/tabs"
import { MessageNav } from "@glitchcode/ui/message-nav"
import { FileSSR } from "@glitchcode/ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@glitchcode/ui/pierre/worker").then((m) => ({
