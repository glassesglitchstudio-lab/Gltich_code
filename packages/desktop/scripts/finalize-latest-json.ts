...
const releaseId = process.env.GLITCHCODE_RELEASE
if (!releaseId) throw new Error("GLITCHCODE_RELEASE is required")

const version = process.env.GLITCHCODE_VERSION
if (!version) throw new Error("GLITCHCODE_VERSION is required")
