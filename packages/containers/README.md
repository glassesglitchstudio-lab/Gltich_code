...
```
REGISTRY=ghcr.io/glassesglitchstudio-lab TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/glassesglitchstudio-lab TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/glassesglitchstudio-lab/build/bun-node:24.04
```
