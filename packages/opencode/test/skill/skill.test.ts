...
process.env.GLITCHCODE_DISABLE_COMPOSE_SKILLS = "true"
...
describe("skill", () => {
  it.live("discovers skills from .glitchcode/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".glitchcode", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".glitchcode", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".glitchcode", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .glitchcode/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".glitchcode", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".glitchcode", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".glitchcode", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".glitchcode", "skill", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .glitchcode/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".glitchcode", "skills", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .glitchcode/skills directory.
---
