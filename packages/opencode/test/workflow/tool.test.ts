...
describe("WorkflowTool run", () => {
  ...
  const originalFlag = Flag.GLITCHCODE_EXPERIMENTAL_WORKFLOW_TOOL
  beforeAll(() => {
    Flag.GLITCHCODE_EXPERIMENTAL_WORKFLOW_TOOL = true
  })
  afterAll(() => {
    Flag.GLITCHCODE_EXPERIMENTAL_WORKFLOW_TOOL = originalFlag
  })
