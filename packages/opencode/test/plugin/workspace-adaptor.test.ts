...
const experimental = Flag.GLITCHCODE_EXPERIMENTAL_WORKSPACES

Flag.GLITCHCODE_EXPERIMENTAL_WORKSPACES = true
...
afterAll(() => {
  ...
  Flag.GLITCHCODE_EXPERIMENTAL_WORKSPACES = experimental
})
