...
process.env["GLITCHCODE_TEST_TMPDIR_ROOT"] = fixtureRoot
afterAll(async () => {
...
process.env["GLITCHCODE_MODELS_PATH"] = path.join(import.meta.dir, "tool", "fixtures", "models-api.json")
...
process.env["GLITCHCODE_TEST_MANAGED_CONFIG_DIR"] = testManagedConfigDir
process.env["GLITCHCODE_DISABLE_DEFAULT_PLUGINS"] = "true"
...
delete process.env["GLITCHCODE_SERVER_PASSWORD"]
delete process.env["GLITCHCODE_SERVER_USERNAME"]
delete process.env["GLITCHCODE_HOME"]

// Use in-memory sqlite
process.env["GLITCHCODE_DB"] = ":memory:"
