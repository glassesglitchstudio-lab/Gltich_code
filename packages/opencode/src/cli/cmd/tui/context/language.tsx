...
const loaders: Record<Exclude<Locale, "en">, () => Promise<Dictionary>> = {
  zh: () => merge(import("@glitchcode/ui/i18n/zh"), import("../i18n/zh")),
  zht: () => merge(import("@glitchcode/ui/i18n/zht"), import("../i18n/zht")),
  ko: () => merge(import("@glitchcode/ui/i18n/ko")),
  de: () => merge(import("@glitchcode/ui/i18n/de")),
  es: () => merge(import("@glitchcode/ui/i18n/es"), import("../i18n/es")),
  fr: () => merge(import("@glitchcode/ui/i18n/fr"), import("../i18n/fr")),
  da: () => merge(import("@glitchcode/ui/i18n/da")),
  ja: () => merge(import("@glitchcode/ui/i18n/ja"), import("../i18n/ja")),
  pl: () => merge(import("@glitchcode/ui/i18n/pl")),
  ru: () => merge(import("@glitchcode/ui/i18n/ru"), import("../i18n/ru")),
  ar: () => merge(import("@glitchcode/ui/i18n/ar")),
  no: () => merge(import("@glitchcode/ui/i18n/no")),
  br: () => merge(import("@glitchcode/ui/i18n/br")),
  th: () => merge(import("@glitchcode/ui/i18n/th")),
  bs: () => merge(import("@glitchcode/ui/i18n/bs")),
  tr: () => merge(import("@glitchcode/ui/i18n/tr")),
}
