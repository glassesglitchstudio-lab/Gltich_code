...
export const dict = {
  ...
  "tui.home.agreement.prefix": "En utilisant Glitch Code, vous acceptez nos ",
  ...
  "tui.tips.formatter": "Glitch Code formate automatiquement les fichiers avec prettier, gofmt, ruff, etc.",
  ...
  "tui.toast.update_available.success": "Mis à jour vers Glitch Code v{{version}}. Veuillez redémarrer l'application.",
  ...
  "trust.capabilities": "Glitch Code pourra lire, modifier et exécuter des fichiers ici.",
