export const dict: Record<string, string> = {
  ...
  "tui.home.agreement.prefix": "By using Glitch Code, you agree to our ",
  ...
  "tui.tips.config_files":
    "Create {highlight}glitchcode.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  "tui.tips.global_config": "Place TUI settings in {highlight}~/.config/glitchcode/tui.json{/highlight} for global config",
  ...
  "tui.tips.mcp_oauth": "Glitch Code auto-handles OAuth for remote MCP servers requiring auth",
  "tui.tips.custom_command":
    "Add {highlight}.md{/highlight} files to {highlight}.glitchcode/command/{/highlight} to define reusable custom prompts",
  ...
  "tui.tips.custom_agent":
    "Add {highlight}.md{/highlight} files to {highlight}.glitchcode/agent/{/highlight} for specialized AI personas",
  ...
  "tui.tips.formatter": "Glitch Code auto-formats files using prettier, gofmt, ruff, and more",
  ...
  "tui.tips.lsp": "Glitch Code uses LSP servers for intelligent code analysis",
  "tui.tips.custom_tool":
    "Create {highlight}.ts{/highlight} files in {highlight}.glitchcode/tools/{/highlight} to define new LLM tools",
  "tui.tips.tool_scripts": "Tool definitions can invoke scripts written in Python, Go, etc",
  "tui.tips.plugins":
    "Add {highlight}.ts{/highlight} files to {highlight}.glitchcode/plugin/{/highlight} for event hooks",
  "tui.tips.plugin_notify": "Use plugins to send OS notifications when sessions complete",
  "tui.tips.plugin_protect": "Create a plugin to prevent Glitch Code from reading sensitive files",
  "tui.tips.run": "Use {highlight}glitch run{/highlight} for non-interactive scripting",
  "tui.tips.continue": "Use {highlight}glitch --continue{/highlight} to resume the last session",
  "tui.tips.attach_cli": "Use {highlight}glitch run -f file.ts{/highlight} to attach files via CLI",
  "tui.tips.format_json": "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "tui.tips.serve": "Run {highlight}glitch serve{/highlight} for headless API access to Glitch Code",
  "tui.tips.attach_server": "Use {highlight}glitch run --attach{/highlight} to connect to a running server",
  "tui.tips.upgrade": "Run {highlight}glitch upgrade{/highlight} to update to the latest version",
  "tui.tips.auth_list": "Run {highlight}glitch auth list{/highlight} to see all configured providers",
  "tui.tips.agent_create": "Run {highlight}glitch agent create{/highlight} for guided agent creation",
  "tui.tips.github_trigger": "Use {highlight}/glitch{/highlight} in GitHub issues/PRs to trigger AI actions",
  "tui.tips.github_install": "Run {highlight}glitch github install{/highlight} to set up the GitHub workflow",
  ...
  "tui.tips.theme_files": "Create JSON theme files in {highlight}.glitchcode/themes/{/highlight} directory",
  ...
  "tui.tips.debug_config": "Run {highlight}glitch debug config{/highlight} to troubleshoot configuration",
  ...
  "tui.tips.docker": "Run {highlight}docker run -it --rm ghcr.io/glitchcode/glitchcode{/highlight} for containerized use",
  "tui.tips.zen": "Use {highlight}/connect{/highlight} with Glitch Code for curated, tested models",
  ...
  "tui.toast.update_available.success": "Successfully updated to Glitch Code v{{version}}. Please restart the application.",
  ...
  "tui.dialog.login.glitch_free.desc": "Anonymous free channel — no login required",
  "tui.dialog.login.glitch_free.success": "Glitch Auto (free) is ready — default model set to glitch/glitch-auto",
  "tui.dialog.login.glitch_free.unavailable": "Glitch Auto (free) provider not loaded",
  "cli.providers.select": "Select provider",
  "cli.providers.other": "Other provider",
  "cli.providers.glitch.recommended_hint": "recommended",
  "cli.providers.glitch_free.hint": "Anonymous free channel / glitch-auto",
  "cli.providers.glitch_free.verifying": "Verifying Glitch Auto (free) channel...",
  "cli.providers.glitch_free.ready": "Glitch Auto (free) channel ready",
  "cli.providers.glitch_free.failed": "Glitch Auto (free) verification failed",
  "cli.providers.glitch_free.default_set": "Default model set to glitch/glitch-auto (1M context, free)",
  "cli.providers.glitch_free.usage_hint": "No login required — just run glitch. For paid/premium models, choose MiMo browser login instead.",
  "cli.providers.glitch_login.decrypt_retry": "Decryption failed, please retry ({remaining} attempts left)",
  "cli.providers.glitch_login.decrypt_exhausted": "Decryption failed, max retries reached",
  ...
  "trust.capabilities": "Glitch Code will be able to read, edit, and execute files here.",
