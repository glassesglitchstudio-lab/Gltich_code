...
export const dict = {
  ...
  "tui.home.agreement.prefix": "Al usar Glitch Code, aceptas nuestros ",
  ...
  "tui.tips.config_files":
    "Crea {highlight}glitchcode.json{/highlight} para la configuración del servidor y {highlight}tui.json{/highlight} para la TUI",
  "tui.tips.global_config":
    "Coloca la configuración de TUI en {highlight}~/.config/glitchcode/tui.json{/highlight} como configuración global",
  "tui.tips.schema":
  ...
  "tui.tips.mcp_oauth":
    "Glitch Code gestiona automáticamente OAuth para servidores MCP remotos que requieran autenticación",
  "tui.tips.custom_command":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.glitchcode/command/{/highlight} para definir indicaciones personalizadas reutilizables",
  ...
  "tui.tips.custom_agent":
    "Añade archivos {highlight}.md{/highlight} en {highlight}.glitchcode/agent/{/highlight} para personajes de IA especializados",
  ...
  "tui.tips.formatter": "Glitch Code formatea archivos automáticamente con prettier, gofmt, ruff y más",
  ...
  "tui.tips.lsp": "Glitch Code usa servidores LSP para análisis inteligente de código",
  "tui.tips.custom_tool":
    "Crea archivos {highlight}.ts{/highlight} en {highlight}.glitchcode/tools/{/highlight} para definir nuevas herramientas LLM",
  "tui.tips.tool_scripts":
    "Las definiciones de herramientas pueden invocar scripts en Python, Go, etc.",
  "tui.tips.plugins":
    "Añade archivos {highlight}.ts{/highlight} en {highlight}.glitchcode/plugin/{/highlight} para enganchar eventos",
  ...
  "tui.tips.plugin_protect":
    "Crea un plugin que impida a Glitch Code leer archivos sensibles",
  "tui.tips.run":
    "Usa {highlight}glitch run{/highlight} para scripting no interactivo",
  "tui.tips.continue":
    "Usa {highlight}glitch --continue{/highlight} para retomar la última sesión",
  "tui.tips.attach_cli":
    "Usa {highlight}glitch run -f file.ts{/highlight} para adjuntar archivos vía CLI",
  "tui.tips.format_json":
    "Usa {highlight}--format json{/highlight} para obtener salida legible por máquina en scripts",
  "tui.tips.serve":
    "Ejecuta {highlight}glitch serve{/highlight} para acceso headless a la API de Glitch Code",
  "tui.tips.attach_server":
    "Usa {highlight}glitch run --attach{/highlight} para conectarte a un servidor en ejecución",
  "tui.tips.upgrade":
    "Ejecuta {highlight}glitch upgrade{/highlight} para actualizar a la última versión",
  "tui.tips.auth_list":
    "Ejecuta {highlight}glitch auth list{/highlight} para ver todos los proveedores configurados",
  ...
  "tui.tips.theme_files":
    "Crea archivos JSON de tema en el directorio {highlight}.glitchcode/themes/{/highlight}",
  ...
  "tui.tips.debug_config":
    "Ejecuta {highlight}glitch debug config{/highlight} para diagnosticar problemas de configuración",
  "tui.tips.print_logs":
  ...
  "tui.toast.update_available.success": "Se actualizó a Glitch Code v{{version}}. Por favor reinicie la aplicación.",
  ...
  "trust.capabilities": "Glitch Code podrá leer, editar y ejecutar archivos aquí.",
