...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 Glitch Code 即表示你同意我們的",
  ...
  "tui.tips.config_files":
    "建立 {highlight}glitchcode.json{/highlight} 用於伺服器端設定，{highlight}tui.json{/highlight} 用於 TUI 設定",
  "tui.tips.global_config": "把 TUI 設定放在 {highlight}~/.config/glitchcode/tui.json{/highlight} 作為全域設定",
  ...
  "tui.tips.mcp_oauth": "Glitch Code 自動處理需要驗證的遠端 MCP 伺服器的 OAuth",
  "tui.tips.custom_command":
    "在 {highlight}.glitchcode/command/{/highlight} 加入 {highlight}.md{/highlight} 檔案以定義可重用自訂提示",
  ...
  "tui.tips.custom_agent":
    "在 {highlight}.glitchcode/agent/{/highlight} 加入 {highlight}.md{/highlight} 檔案來建立專用 AI 角色",
  ...
  "tui.tips.formatter": "Glitch Code 自動使用 prettier、gofmt、ruff 等格式化檔案",
  ...
  "tui.tips.lsp": "Glitch Code 使用 LSP 伺服器進行智慧程式碼分析",
  "tui.tips.custom_tool":
    "在 {highlight}.glitchcode/tools/{/highlight} 建立 {highlight}.ts{/highlight} 檔案定義新的 LLM 工具",
  "tui.tips.tool_scripts": "工具定義可呼叫 Python、Go 等指令稿",
  "tui.tips.plugins":
    "在 {highlight}.glitchcode/plugin/{/highlight} 加入 {highlight}.ts{/highlight} 檔案掛載事件勾點",
  "tui.tips.plugin_notify": "用外掛在工作階段完成時傳送系統通知",
  "tui.tips.plugin_protect": "撰寫一個外掛阻止 Glitch Code 讀取敏感檔案",
  "tui.tips.run": "用 {highlight}glitch run{/highlight} 進行非互動式指令稿呼叫",
  "tui.tips.continue": "用 {highlight}glitch --continue{/highlight} 繼續上一個工作階段",
  "tui.tips.attach_cli": "用 {highlight}glitch run -f file.ts{/highlight} 透過命令列附加檔案",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在指令稿中取得機器可讀輸出",
  "tui.tips.serve": "執行 {highlight}glitch serve{/highlight} 以無介面模式提供 Glitch Code API",
  "tui.tips.attach_server": "用 {highlight}glitch run --attach{/highlight} 連線到正在執行的服務",
  "tui.tips.upgrade": "執行 {highlight}glitch upgrade{/highlight} 升級到最新版本",
  "tui.tips.auth_list": "執行 {highlight}glitch auth list{/highlight} 檢視所有已設定的供應商",
  "tui.tips.agent_create": "執行 {highlight}glitch agent create{/highlight} 引導式建立智慧代理",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中輸入 {highlight}/glitch{/highlight} 觸發 AI 操作",
  "tui.tips.github_install": "執行 {highlight}glitch github install{/highlight} 設定 GitHub workflow",
  ...
  "tui.tips.theme_files": "在 {highlight}.glitchcode/themes/{/highlight} 目錄下建立 JSON 主題檔案",
  ...
  "tui.tips.debug_config": "執行 {highlight}glitch debug config{/highlight} 排查設定問題",
  ...
  "tui.tips.docker": "執行 {highlight}docker run -it --rm ghcr.io/glitchcode/glitchcode{/highlight} 使用容器化版本",
  "tui.tips.zen": "搭配 Glitch Code 使用 {highlight}/connect{/highlight} 選用經過測試的精選模型",
  ...
  "tui.toast.update_available.success": "已更新到 Glitch Code v{{version}}，請重新啟動應用程式。",
  ...
  "trust.capabilities": "Glitch Code 將能夠讀取、編輯和執行此目錄中的檔案。",
