...
export const dict = {
  ...
  "tui.home.agreement.prefix": "使用 Glitch Code 即表示你同意我们的",
  ...
  "tui.tips.formatter": "Glitch Code 自动使用 prettier、gofmt、ruff 等格式化文件",
  ...
  "tui.tips.run": "用 {highlight}glitch run{/highlight} 进行非交互式脚本调用",
  "tui.tips.continue": "用 {highlight}glitch --continue{/highlight} 继续上一个会话",
  "tui.tips.attach_cli": "用 {highlight}glitch run -f file.ts{/highlight} 通过命令行附加文件",
  "tui.tips.format_json": "用 {highlight}--format json{/highlight} 在脚本中获得机器可读输出",
  "tui.tips.serve": "运行 {highlight}glitch serve{/highlight} 以无头模式提供 Glitch Code API",
  "tui.tips.attach_server": "用 {highlight}glitch run --attach{/highlight} 接入正在运行的服务",
  "tui.tips.upgrade": "运行 {highlight}glitch upgrade{/highlight} 升级到最新版本",
  "tui.tips.auth_list": "运行 {highlight}glitch auth list{/highlight} 查看所有已配置的 provider",
  "tui.tips.agent_create": "运行 {highlight}glitch agent create{/highlight} 引导式创建智能体",
  "tui.tips.github_trigger": "在 GitHub issue/PR 中输入 {highlight}/glitch{/highlight} 触发 AI 操作",
  "tui.tips.github_install": "运行 {highlight}glitch github install{/highlight} 配置 GitHub workflow",
  ...
  "tui.tips.debug_config": "运行 {highlight}glitch debug config{/highlight} 排查配置问题",
  ...
  "tui.tips.docker": "运行 {highlight}docker run -it --rm ghcr.io/glitchcode/glitchcode{/highlight} 使用容器化版本",
  "tui.tips.zen": "搭配 Glitch Code 使用 {highlight}/connect{/highlight} 选用经过测试的精选模型",
  ...
  "tui.toast.update_available.success": "已更新到 Glitch Code v{{version}}，请重启应用。",
  ...
  "tui.dialog.login.glitch_free.desc": "免费匿名通道，无需登录",
  "tui.dialog.login.glitch_free.success": "Glitch Auto (free) 已就绪 - 默认模型设为 glitch/glitch-auto",
  "tui.dialog.login.glitch_free.unavailable": "Glitch Auto (free) 通道未加载",
  "cli.providers.select": "选择服务商",
  "cli.providers.other": "其他 Provider",
  "cli.providers.glitch.recommended_hint": "推荐",
  "cli.providers.glitch_free.hint": "免费匿名通道 / glitch-auto",
  "cli.providers.glitch_free.verifying": "正在验证 Glitch Auto (free) 通道...",
  "cli.providers.glitch_free.ready": "Glitch Auto (free) 通道已就绪",
  "cli.providers.glitch_free.failed": "Glitch Auto (free) 自检失败",
  "cli.providers.glitch_free.default_set": "默认模型已切换为 glitch/glitch-auto（1M 上下文，免费）",
  "cli.providers.glitch_free.usage_hint": "无需登录，直接 glitch run 即可使用。如需付费/更高级模型，可重新选择 MiMo 浏览器登录。",
  "cli.providers.glitch_login.decrypt_retry": "解密失败，请重试 (剩余 {remaining} 次)",
  "cli.providers.glitch_login.decrypt_exhausted": "解密失败，已达最大重试次数",
  ...
  "trust.capabilities": "Glitch Code 将能够读取、编辑和执行此目录中的文件。",
