...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@glitchcode/sdk/v2"
      ...
      description={
        {
          ...
          "opencode-go": (
            <box gap={1}>
              <text fg={theme.textMuted}>
                Glitch Code Go is a $10 per month subscription that provides reliable access to popular open coding models
                with generous usage limits.
              </text>
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://glitchcode.dev/zen</span> and enable Glitch Code Go
              </text>
            </box>
          ),
