...
export function ErrorComponent(props: {
  ...
  const issueURL = new URL("https://github.com/glassesglitchstudio-lab/Gltich_code/issues/new?template=bug-report.yml")
  ...
  issueURL.searchParams.set("glitchcode-version", InstallationVersion)
