...
function pagerCmd(): string[] {
  ...
  if (Flag.GLITCHCODE_GIT_BASH_PATH) {
    const less = path.join(Flag.GLITCHCODE_GIT_BASH_PATH, "..", "..", "usr", "bin", "less.exe")
...
export const SessionImportClaudeCommand = cmd({
  ...
  describe: "import Claude Code sessions (~/.claude/projects) into glitchcode",
  builder: (yargs: Argv) =>
    yargs.option("force", {
