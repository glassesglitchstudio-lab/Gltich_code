...
const OUTPUT_LENGTH_CONTINUATION_LIMIT = Flag.GLITCHCODE_OUTPUT_LENGTH_CONTINUATION_LIMIT
const INVALID_OUTPUT_CONTINUATION_LIMIT = Flag.GLITCHCODE_INVALID_OUTPUT_CONTINUATION_LIMIT
      ...
      const result = yield* actorTool
        ...
        .pipe(
          ...
          Effect.onInterrupt(() =>
            ...
            metadata: part.state.status !== "pending" ? part.state.metadata : undefined,
    ...
    const runLoop: (sessionID: SessionID, agentID?: string, task_id?: string) => Effect.Effect<MessageV2.WithParts> = Effect.fn(
      ...
      function* (sessionID: SessionID, agentID?: string, task_id?: string) {
        ...
        const publishAgentRequest = (phase: string, taskType: string) =>
          bus
            .publish(Metrics.AgentRequest, {
              ...
              phase,
              task_type: taskType,
              surface: Flag.GLITCHCODE_CLIENT,
        ...
        while (true) {
          ...
          // (explore/general/etc) spawned via glitchcode's shared-sessionID
