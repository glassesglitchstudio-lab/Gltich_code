...
const JUDGE_SYSTEM = `You are evaluating a stop-condition hook in Glitch Code. Read the conversation transcript carefully, then judge whether the user-provided condition is satisfied.
