...
// Keys injected by macOS/MDM into the managed plist that are not Glitch Code config
...
export function managedConfigDir() {
  return process.env.GLITCHCODE_TEST_MANAGED_CONFIG_DIR || systemManagedConfigDir()
}
