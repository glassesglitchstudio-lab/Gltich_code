  ...
  Effect.gen(function* () {
      ...
      Effect.fn("Agent.state")(function* (_ctx) {
        ...
        const agents: Record<string, Info> = {
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".glitchcode", "plans", "*.md")]: "allow",
          ...
          architect: {
            name: "architect",
            color: "#4fc3f7",
            description: "Architect mode. Read-only design and planning. No edits, no bash, no writes.",
            options: {},
            permission: Permission.merge(
              defaults,
              Permission.fromConfig({
          ...
          review: {
            name: "review",
            color: "#ff9800",
            description: "Review mode. Code review and analysis only. Read files, analyze, critique.",
            options: {},
            permission: Permission.merge(
              defaults,
              Permission.fromConfig({
                ...
                edit: { "*": "deny" },
                write: "deny",
                bash: { "*": "ask", "echo*": "allow", "cat*": "allow", "head*": "allow", "tail*": "allow", "grep*": "allow", "ls*": "allow", "find*": "allow", "wc*": "allow", "sort*": "allow", "uniq*": "allow" },
              }),
              user,
            ),
            mode: "primary",
        ...
        const list = Effect.fnUntraced(function* () {
          ...
          return pipe(
            ...
            sortBy(
              ...
              [(x) => x.name === "build", "desc"],
              [(x) => x.name === "plan", "desc"],
              [(x) => x.name === "architect", "desc"],
              [(x) => x.name === "review", "desc"],
    ...
    return Service.of({
      ...
      generate: Effect.fn("Agent.generate")(function* (input: {
        ...
        const useInstructionsSystem = ProviderTransform.usesInstructionsForSystem(model.providerID, authInfo?.type)
