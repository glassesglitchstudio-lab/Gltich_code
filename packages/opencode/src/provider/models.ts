...
function url() {
  return Flag.GLITCHCODE_MODELS_URL || "https://models.dev"
}
...
export const Data = lazy(async () => {
  ...
  if (Flag.GLITCHCODE_DISABLE_MODELS_FETCH) return {}
...
if (!Flag.GLITCHCODE_DISABLE_MODELS_FETCH && !process.argv.includes("--get-yargs-completions")) {
  void refresh()
  setInterval(
    async () => {
      await refresh()
