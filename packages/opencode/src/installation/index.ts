...
export const USER_AGENT = `glitchcode/${InstallationChannel}/${InstallationVersion}/${Flag.GLITCHCODE_CLIENT}`
...
export class Service extends Context.Service<Service, Interface>()("@glitchcode/Installation") {}
  ...
  Layer.effect(
    ...
    Effect.gen(function* () {
      ...
      const methodImpl = Effect.fn("Installation.method")(function* () {
        if (process.execPath.includes(path.join(".glitchcode", "bin"))) return "curl" as Method
