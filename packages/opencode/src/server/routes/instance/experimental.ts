  ...
  new Hono()
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Persist a new active Console account/org selection for the current local Glitch Code state.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description:
          "Get a list of all Glitch Code sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.",
