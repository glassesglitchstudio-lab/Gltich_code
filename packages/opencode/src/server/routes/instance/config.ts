  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current Glitch Code configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update Glitch Code configuration settings and preferences.",
