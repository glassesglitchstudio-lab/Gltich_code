  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Glitch Code sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Glitch Code session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Glitch Code session for interacting with AI assistants and managing conversations.",
    ...
    .post(
      ...
      async (c) => {
        ...
        return stream(c, async (stream) => {
          const body = c.req.valid("json")
          // If the HTTP client gives up (TUI exits, driver kills its `glitch run`
