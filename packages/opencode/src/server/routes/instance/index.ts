...
export const InstanceRoutes = (upgrade: UpgradeWebSocket): Hono => {
  ...
  if (Flag.GLITCHCODE_EXPERIMENTAL_HTTPAPI) {
  ...
  return app
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose the current Glitch Code instance, releasing all resources.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get paths",
        description: "Retrieve the current working directory and related path information for the Glitch Code instance.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all available commands in the Glitch Code system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List agents",
        description: "Get a list of all available AI agents in the Glitch Code system.",
    ...
    .get(
      ...
      describeRoute({
        summary: "List skills",
        description: "Get a list of all available skills in the Glitch Code system.",
