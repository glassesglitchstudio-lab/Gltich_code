      ...
      .add(
        HttpApiEndpoint.get("list", root, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of projects that have been opened with Glitch Code.",
          }),
        ),
        HttpApiEndpoint.get("current", `${root}/current`, {
          ...
          OpenApi.annotations({
            ...
            description: "Retrieve the currently active project that Glitch Code is working with.",
          }),
        ),
      )
      .annotateMerge(
