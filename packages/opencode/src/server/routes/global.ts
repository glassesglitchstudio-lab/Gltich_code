...
const EVENT_QUEUE_CAPACITY = Number(process.env["GLITCHCODE_EVENT_QUEUE_CAPACITY"]) || 10_000
...
export const GlobalRoutes = lazy(() =>
  new Hono()
    .get(
      ...
      describeRoute({
        summary: "Get health",
        description: "Get health information about the Glitch Code server.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Subscribe to global events from the Glitch Code system using server-sent events.",
    ...
    .get(
      ...
      describeRoute({
        ...
        description: "Retrieve the current global Glitch Code configuration settings and preferences.",
    ...
    .patch(
      ...
      describeRoute({
        ...
        description: "Update global Glitch Code configuration settings and preferences.",
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Clean up and dispose all Glitch Code instances, releasing all resources.",
