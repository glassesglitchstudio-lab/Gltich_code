...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/glassesglitchstudio-lab/Glitch-Code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for glassesglitchstudio-lab/Glitch-Code...\n")
